...
double time_taken = 0, time_taken1 = 0;
...
int main()
{
	...
	time_taken1 = time_taken + chrono::duration_cast<chrono::nanoseconds>(End1 - start1).count();

	time_taken1 *= 1e-9;
	cout << "time taken is " << fixed << time_taken1 << setprecision(9) << " sec" << endl;
}
